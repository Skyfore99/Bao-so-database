...
const Toast = ({ msg, type, show, onClose }) => {
    ...
    return (
        <div
            className={`fixed bottom-8 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-full shadow-lg text-white text-sm font-medium z-[60] transition-all duration-300 flex items-center gap-2 ${type === "error" ? "bg-red-500" : "bg-slate-800"
                }`}
        >
            {type === "error" ? (
...
export default function App() {
    ...
    const submitData = async (e) => {
        ...
        try {
            ...
            // 2. Update Config: Update luy_ke and nhom
            if (selectedItem.id) {
                await supabase
                    .from("config")
                    .update({
                        nhom: currentGroup,
                        luy_ke: newCumulative
                    })
    ...
    return (
        <div className="bg-slate-100 min-h-screen w-full flex justify-center items-center font-sans text-slate-800">
            <div className="w-full h-[100dvh] sm:h-[90vh] sm:w-[480px] bg-white sm:rounded-2xl shadow-2xl flex flex-col relative overflow-hidden">
                ...
                <header className="bg-slate-900 text-white p-4 flex justify-between items-center shrink-0 z-30 shadow-md sticky top-0">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className={`w-9 h-9 rounded-full flex items-center justify-center transition ${syncStatus === "complete"
                        ...
                        <button
                            ...
                            className={`w-9 h-9 rounded-full flex items-center justify-center transition ${showConfig
                ...
                {/* CONFIG PANEL */}
                <div
                    className={`bg-slate-50 border-b border-slate-200 p-4 absolute top-[64px] left-0 w-full z-30 transition-all duration-300 shadow-lg ${showConfig
                        ? "translate-y-0"
                ...
                >
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <span
                            className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${connectionStatus === "connected"
                ...
                <div className="p-2 bg-slate-50 border-b border-slate-200 shrink-0 z-10">
                    <div className="flex bg-slate-200/50 p-1 rounded-xl">
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-all flex items-center justify-center gap-2 ${activeTab === "input"
                        ...
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-all flex items-center justify-center gap-2 ${activeTab === "report"
                                ? "text-blue-700 bg-white shadow-sm"
                                : "text-slate-500 hover:text-slate-700"
                                }`}
                        >
                                        ...
                                        {itemsToDisplay.map((item, idx) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`bg-white p-2 rounded-lg border cursor-pointer transition-all active:scale-[0.98] h-full flex flex-col justify-between ${selectedItem === item
                                                ...
                                                >
                                                    ...
                                                    <div className="flex justify-between items-end mt-1 pt-1 border-t border-slate-50">
                                                        ...
                                                        <div className="flex items-center gap-1 shrink-0">
                                                            ...
                                                            <div
                                                                className={`px-1.5 py-1 rounded text-[10px] font-bold border min-w-[45px] text-center ${diff > 0
                                    ...
                                    <div className="grid grid-cols-3 gap-2 mb-3 bg-slate-50 p-2 rounded-lg border border-slate-100">
                                        ...
                                        <div className="text-center">
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <div
                                                        className={`font-bold ${diff > 0 ? "text-red-500" : "text-green-600"
                                                            }`}
                                                    >
                                                        {diff > 0 ? "+" : ""}
                                                        {formatDecimal(diff)}
